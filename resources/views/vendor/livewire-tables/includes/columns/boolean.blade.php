...
@if ($theme === 'tailwind')
    @if ($status)
        @if ($type === 'icons')
            <svg xmlns="http://www.w3.org/2000/svg" class="inline-block h-5 w-5 @if ($successValue === true) text-[#42a692] @else text-red-600 @endif" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    @else
        @if ($type === 'icons')
            <svg xmlns="http://www.w3.org/2000/svg" class="inline-block h-5 w-5 @if ($successValue === false) text-[#42a692] @else text-red-600 @endif" fill="none" viewBox="0 0 24 24" stroke="currentColor">
