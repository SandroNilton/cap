                    ...
                    @else
                        ...
                        >
                            ...
                            <button
                                ...
                                type="button"
                                class="flex-shrink-0 ml-0.5 h-4 w-4 rounded-full inline-flex items-center justify-center text-white hover:bg-[#2c6f62] hover:text-white focus:outline-none focus:bg-[#2c6f62] focus:text-white"
                            >
