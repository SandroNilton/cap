    ...
    @if ($theme === 'tailwind')
        <div class="rounded shadow-sm">
            <input
                ...
                class="py-1.5 text-sm block w-full border-[#cfd7df] hover:border-[#42a692] transition duration-300 focus:border-[#42a692] cursor-pointer focus:outline-none focus:ring-0 rounded shadow-sm ease-in-out dark:bg-gray-800 dark:text-white dark:border-gray-600"
            />
        </div>
